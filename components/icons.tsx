...
export const RocketIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 3.414A1.5 1.5 0 0110.5 2h3a1.5 1.5 0 011.5 1.5v1.086M9 3.414a1.5 1.5 0 00-1.06.44L4.44 7.394a1.5 1.5 0 000 2.12l7.072 7.072a1.5 1.5 0 002.12 0L20.56 9.514a1.5 1.5 0 000-2.12l-3.536-3.536a1.5 1.5 0 00-1.06-.44H9z" />
    </svg>
);
