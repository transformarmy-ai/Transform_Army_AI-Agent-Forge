  ...
  return (
    <header className="border-b-2 border-[--color-border-accent]/50 p-4 bg-[--color-bg-secondary]/90 backdrop-blur-md sticky top-0 z-10 flex items-center justify-center space-x-4 shadow-lg">
      <div className="relative">
        ...
        <div className="absolute inset-0 h-12 md:h-16 w-auto bg-[--color-glow-red] blur-xl opacity-50 -z-10"></div>
      </div>
      <div className="text-center">
        <h1 className="text-2xl md:text-4xl font-bold font-orbitron text-[--color-accent-red] tracking-widest uppercase"
            style={{
              textShadow: '0 0 20px var(--color-glow-red), 0 0 40px rgba(220, 20, 60, 0.4)',
        ...
        <p className="text-sm md:text-base text-[--color-accent-blue] font-mono mt-1 text-center uppercase tracking-widest"
           style={{
             textShadow: '0 0 10px var(--color-glow-blue), 0 0 20px rgba(0, 48, 143, 0.3)',
             letterSpacing: '0.2em'
           }}>
